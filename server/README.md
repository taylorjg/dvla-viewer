...
The monorepo workflow (`.github/workflows/ci-cd.yaml`) runs `npm run check` in this directory as the **Run server checks** job. That job is required for merges to `main`.
